...
/*                                                                            */
/*                                                        ::::::::            */
/*   get_new_position_a.c                               :+:    :+:            */
/*                                                     +:+                    */
/*   By: jaka <jaka@student.codam.nl>                 +#+                     */
/*                                                   +#+                      */
/*   Created: 2021/08/31 11:43:07 by jmurovec      #+#    #+#                 */
...
void	new_position_a_q2(float old_posX, float old_posY, t_window *w)
{
	...
	fieldnr = (int)(floor(old_posX) + floor(old_posY) * w->map.nr_cols);
	w->pos.my_x = w->pos.my_x + cos((90 - (w->pos.myrot - 90)) * RAD) * STEP;
	w->pos.my_y = w->pos.my_y - sin((90 - (w->pos.myrot - 90)) * RAD) * STEP;
